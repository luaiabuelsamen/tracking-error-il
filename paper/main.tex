...
evaluations that begin after a scripted approach; a third evaluation was
interrupted by hardware faults. The benefit varies
...
$n$ seeds, and no contrast among the 28 design pairs survives a Holm
adjustment (Appendix~\ref{app:sim}). Because the residual subtracts a
...
detect only large effects (Appendix~\ref{app:protocol}).
