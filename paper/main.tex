...
65-point improvement and two seeds cannot bound that spread. The matched position-history control is registered but not yet evaluated on
hardware (Appendix~\ref{app:history}), so the hardware result establishes the
...
\label{tab:history}
\input{generated/history_control.tex}
\end{table}
